...
export function SendPaymentModal({ onClose }: SendPaymentModalProps) {
  ...
  // Full screen animation for success
  if (step === 'success') {
    return (
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg bg-[#0a0a0a] border border-white/[0.06] rounded-2xl p-6 max-h-[90vh] overflow-y-auto">
              ...
              <div className="grid grid-cols-2 gap-2">
                {privacyOptions.map((option) => (
                  ...
                  >
                    ...
                    {option.badge && (
                      <span className="absolute top-2 right-6 text-[8px] px-1.5 py-0.5 rounded bg-white/10 text-white/40">
                        {option.badge}
                      </span>
                    )}
                    <option.icon
            ...
            {selectedPrivacy === 'ZK_COMPRESSED' && (
              <div className="mb-4 p-3 bg-white/[0.02] border border-white/[0.06] rounded-xl">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <p className="text-white text-xs font-medium mb-1">Light Protocol ZK Compression</p>
            ...
            {selectedPrivacy === 'SEMI' && stealthResult && (
              <div className="mb-6 p-4 bg-white/[0.02] border border-white/[0.06] rounded-xl">
                ...
                <p className="text-xs text-white/30">
                  Funds go here. <span className="text-white/60">Unique to this payment</span> - unlinkable to recipient.
                </p>
              </div>
            )}
        ...
        {step === 'error' && (
          <div className="py-8 text-center">
            <div className="w-24 h-24 mx-auto mb-6 bg-white/[0.03] rounded-full flex items-center justify-center border border-white/[0.1]">
